...
const Logo = (props: ILogoProps) => {
  ...
  return (
    <span className={`inline-flex items-center text-gray-900 ${fontStyle}`}>
      ...
      <p className="text-blue-500">{AppConfig.site_name}</p>
    </span>
  );
};
