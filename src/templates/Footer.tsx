...
const links = [
  ...
  { label: "GitHub", href: "https://github.com/eras-fyi", targetBlank: true },
];
    ...
    <Background className="bg-slate-100 dark:bg-gray-900">
      <Section>
        <CenteredFooter
          ...
          iconList={
            <>
              <Link target="_blank" href="https://github.com/eras-fyi">
                <svg
              ...
              <Link target="_blank" href="https://twitter.com/erasfyi/">
                <svg
                  className="h-5 w-5 fill-current"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <Link
                target="_blank"
                href="https://www.linkedin.com/company/eras-fyi/"
              >
                <svg
                  className="h-5 w-5 fill-current"
                  viewBox="0 0 24 24"
              ...
              <Link href="mailto:info@eras.fyi">
                <svg
                  width="24"
                  height="24"
                  className="h-5 w-5"
        ...
        >
          {links.map((link) => (
            <li className="mx-4" key={link.label}>
              <Link
